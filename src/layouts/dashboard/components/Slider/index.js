            ...
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              >
                <ArgonTypography variant="caption" color="dark" lineHeight={0}>
                  <ArgonBox component="i" color="dark" className="ni ni-parking" />
                </ArgonTypography>
              </ArgonBox>
              ...
              <ArgonTypography variant="body2" color="white">
                Find secure and convenient parking spaces for your vehicle.
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
        <SwiperSlide>
          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="body2" color="white">
                Enjoy easy access to parking spots in busy areas.
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
        <SwiperSlide>
          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="body2" color="white">
                Park your vehicle at affordable rates in prime locations.
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
